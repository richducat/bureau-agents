...
export const MANAGED_CATALOG = {
  'market-research': {
    ...
    deliverables: ['Executive brief', 'Source-linked findings', 'Structured comparison'], unitLabel: 'competitors or market entities', unitCapacity: 5, maximumAutomaticUnits: 15,
  ...
  'spreadsheet-cleanup': {
    ...
    deliverables: ['Clean export', 'Exceptions sheet', 'Quality summary'], unitLabel: 'spreadsheet rows', unitCapacity: 10_000, maximumAutomaticUnits: 30_000,
  ...
  'website-fix': {
    ...
    deliverables: ['Root-cause summary', 'Tested change', 'Deployment notes'], unitLabel: 'reproducible website issues', unitCapacity: 1, maximumAutomaticUnits: 3,
  ...
  'support-backlog': {
    ...
    deliverables: ['Triage queue', 'Resolved or drafted replies', 'Escalation report'], unitLabel: 'support tickets', unitCapacity: 50, maximumAutomaticUnits: 200,
  ...
  'content-brief': {
    ...
    deliverables: ['Search brief', 'Source record', 'Outline and metadata'], unitLabel: 'content briefs', unitCapacity: 1, maximumAutomaticUnits: 5,
  ...
  'invoice-review': {
    ...
    deliverables: ['Exception queue', 'Evidence workbook', 'Findings summary'], unitLabel: 'invoices', unitCapacity: 100, maximumAutomaticUnits: 500,
