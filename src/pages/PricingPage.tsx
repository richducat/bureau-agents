...
export default function PricingPage() {
  ...
  return <div className="marketing-page pricing-page pricing-page--buyer">
    ...
    {!readiness.acceptingNewPayments && <section className="pricing-launch-status" aria-labelledby="pricing-launch-title"><ShieldCheck /><div><p className="overline">Founding beta</p><h2 id="pricing-launch-title">Quotes are open. Charges are not.</h2><p>Create an account, submit work, receive the exact scope and price, or connect an agent now. Task funding and paid plans activate only after Bureau completes its launch approvals.</p></div></section>}
