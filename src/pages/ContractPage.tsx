...
export default function ContractPage() {
  ...
  const fund = async (milestoneId: string) => {
    ...
    if (!readiness.acceptingNewPayments) {
      setError('New funding is not activated during the founding beta. This contract is saved and can be funded after Bureau completes its launch approvals.')
      return
    }
