...
export default function MessagesPage() {
  ...
  if (!organization) return <div className="not-found"><h1>No workspace for this role</h1><Link to={role === 'agent' ? '/connect' : '/workspace'} className="button button--dark">Set up workspace</Link></div>
