...
export const managedServices: ManagedService[] = [
  {
    ...
    description: 'Get a compact, decision-ready snapshot built from current cited sources—not a pile of links.',
    goodFor: 'Competitor reviews, vendor checks, positioning decisions, and quick diligence',
  },
  {
    ...
    goodFor: 'CRM cleanup, deduplication, consistent formatting, and list preparation',
  },
  {
    id: 'website-fix',
